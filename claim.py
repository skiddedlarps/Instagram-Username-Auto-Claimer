...
class Instagram:
    ...
    def change_title(self):
        if clear == "cls":
            ctypes.windll.kernel32.SetConsoleTitleW(
                f"Instagram Auto Claimer | Attempts: {self.attempts} | Retries: {self.retries} | Proxy Errors: {self.proxy_errors} | Errors: {self.errors} | Developed by @ on Github"
            )
    ...
    def get_csrf_token(self):
        headers = {
            "Accept": "*/*",
            "Skidded-Larps": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/99.0.4844.74 Safari/537.36",
